...
public class MongoDBClient {
    ...
    /*
     * @ClassName MongoDBClient
     * @Desc TODO   在指定集合中添加集合数据
     * @Date 2019/4/1 11:12
     * @Version 1.0
     */
    public void addCollection(Collection<?> batchToSave, String collectionName){
        mongoTemplate.insert(batchToSave,collectionName);
    }

    /*
      * @ClassName MongoDBClient
      * @Desc TODO  在指定集合中添加对象数据
      * @Date 2019/11/2 5:21 PM
      * @Version 1.0
     */
    public void addObject(Object obj, String collectionName) {
